locals {
  ...
  combined_objects_subscription_diagnostics                       = merge(tomap({ (local.client_config.landingzone_key) = module.subscription_diagnostics }), try(var.remote_objects.subscription_diagnostics, {}))
