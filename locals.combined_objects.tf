locals {
  ...
  combined_objects_messaging_notification_hub                     = merge(tomap({ (local.client_config.landingzone_key) = module.notification_hub }), try(var.remote_objects.notification_hub, {}))
  combined_objects_messaging_notification_hub_authorization_rule  = merge(tomap({ (local.client_config.landingzone_key) = module.notification_hub_authorization_rule }), try(var.remote_objects.notification_hub_authorization_rule, {}))
