locals {
  ...
  combined_objects_postgresql_flexible_server                     = merge(tomap({ (local.client_config.landingzone_key) = module.postgresql_flexible_server }), try(var.remote_objects.postgresql_flexible_server, {}))
