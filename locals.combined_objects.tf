locals {
  ...
  combined_objects_messaging_notification_hub_namespaces          = merge(tomap({ (local.client_config.landingzone_key) = module.notification_hub_namespaces }), try(var.remote_objects.notification_hub_namespaces, {}))
