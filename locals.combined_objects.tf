locals {
  ...
  combined_objects_mysql_flexible_servers                         = merge(tomap({ (local.client_config.landingzone_key) = module.mysql_flexible_servers }), try(var.remote_objects.mysql_flexible_server, {}))
