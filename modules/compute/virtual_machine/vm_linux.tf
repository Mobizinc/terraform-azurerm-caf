...
resource "azurerm_linux_virtual_machine" "vm" {
  ...
  admin_password                  = each.value.disable_password_authentication == false ? try(each.value.admin_password ,data.azurerm_key_vault_secret.vm_keyvault_secret[0].value)  : null
