      ...
      dynamic "rule" {
        ...
        content {
          metric_trigger {
            ...
            metric_resource_id       = can(rule.value.metric_trigger.metric_resource_id) ? rule.value.metric_trigger.metric_resource_id : try(var.application_insights[var.application_insights.lz_key][var.application_insights.rule.value.metric_trigger.app_insight_key].id, var.application_insights[var.client_config.landingzone_key][var.application_insights.rule.value.metric_trigger.app_insight_key].id,  var.target_resource_id)
