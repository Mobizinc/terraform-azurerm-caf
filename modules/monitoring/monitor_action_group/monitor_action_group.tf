  ...
  dynamic "event_hub_receiver" {
    ...
    content {
      ...
      event_hub_id = coalesce(
        try(var.remote_objects.event_hubs[event_hub_receiver.value.event_hub.lz_key][event_hub_receiver.value.event_hub.key].id, null),
        try(var.remote_objects.event_hubs[var.client_config.landingzone_key][event_hub_receiver.value.event_hub.key].id, null),
        try(event_hub_receiver.value.event_hub.event_hub_id, null)
      )
