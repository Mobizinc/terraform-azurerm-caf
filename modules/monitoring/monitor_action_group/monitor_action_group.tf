...
resource "azurerm_monitor_action_group" "this" {
  ...
  dynamic "automation_runbook_receiver" {
    ...
    content {
      ...
      automation_account_id   = can(automation_runbook_receiver.value.automation_account_id) ? automation_runbook_receiver.value.automation_account_id : var.combined_objects_automations[try(automation_runbook_receiver.value.lz_key, var.client_config.landingzone_key)][automation_runbook_receiver.value.automation_account_key].id
